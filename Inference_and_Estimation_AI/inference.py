...
class DiscreteDistribution(dict):
    ...
    def sample(self):
        ...
        return list(self.keys())[-1] # In case bad key
...
class ExactInference(InferenceModule):
    ...
    def elapseTime(self, gameState):
        ...
        for oldPos in self.allPositions:
            ...
            if oldProb == 0: # if 0 I could skip it right?
                continue

            newPosDist = self.getPositionDistribution(gameState, oldPos)

            for newPos, prob in newPosDist.items():
                newBeliefs[newPos] += prob * oldProb #accumulate probs
...
class ParticleFilter(InferenceModule):
    ...
    def initializeUniformly(self, gameState):
        ...
        for i in range(self.numParticles): # evenly not randomly :3
    ...
    def observeUpdate(self, observation, gameState):
        ...
        if weights.total() == 0: # all 0 weight
            self.initializeUniformly(gameState)
            return
    ...
    def elapseTime(self, gameState):
        ...
        for oldPos in self.particles:
            ...
            newParticles.append(newPos) # add to list
